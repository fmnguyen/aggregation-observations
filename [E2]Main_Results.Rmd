...
# usage
packages <- c("tidyverse", "devtools", "ggplot2", "prodlim", "readr", "knitr", "ltm", "rethinking", "plyr", "dplyr", "GeneNet", "reshape", "MASS", "magrittr", "tidybayes", "svglite", "ggridges", "colorspace", "personograph")
ipak(packages)
...
df_avgConfPerWorkerInsightClass <- df_50 %>%
